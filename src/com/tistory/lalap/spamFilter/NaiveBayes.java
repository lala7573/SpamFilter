...
public class NaiveBayes {
    ...
    public static void setLikelihood() {
        try {
            ...
            //FileReader fr = new FileReader("/Users/YeonjuMac/Documents/Projects/SpamFilter/src/com/tistory/lalap/spamFilter/Spambase.txt");
            //BufferedReader reader = new BufferedReader(fr);

            if (setKey(reader)) return;
            setValue(reader);
    ...
    private static boolean setKey(BufferedReader reader) throws IOException {
        String line;
